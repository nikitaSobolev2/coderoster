...
describe('admin.aiCodeImprove router (integration)', () => {
  it('aiCodeImprove_throws_FORBIDDEN_for_LEARNER', async () => {
    ...
    await expect(caller.admin.aiCodeImprove.get()).rejects.toThrow(/FORBIDDEN|denied/i)
  })
})
