...
describe('admin.livechat router (integration)', () => {
  it('livechat_setGuestPolicy_throws_FORBIDDEN_for_LEARNER', async () => {
    ...
    await expect(caller.admin.livechat.setGuestPolicy({ allowGuests: true })).rejects.toThrow(
      /FORBIDDEN|denied/i
    )
  })
})
