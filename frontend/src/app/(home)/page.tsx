...
import DescriptionWithAnimationList from '~/features/home/components/ui/DescriptionWithAnimationList'
import DescriptionWithAngryAnimation from '~/features/home/components/ui/DescriptionWithAngryAnimation'
import DescriptionWithRainAnimation from '~/features/home/components/ui/DescriptionWithRainAnimation'
      ...
      <main className={styles.main}>
        <section id="home" className={styles.main__hero}>
          ...
          <p className={styles.hero__description}>
            CodeRoster — увлекательный способ прокачать свои навыки программирования
          </p>
          <InteractiveButton className={styles.hero__button} href="/login">
            Начать сейчас
          </InteractiveButton>
        </section>
        <section id="big-true" className={styles.main__bigTrue}>
