    ...
    modules: [
      moduleBlock('Старт в консоли', 'Печать и литералы.', [
        lesson(
          'python-basics-m1-l1',
          'Привет, Кодиум',
          '## Условие\n\nВыведи **ровно** одну строку: `Hello, Кодиум`.\n\n**Формат вывода:** одна строка в stdout, без лишних пробелов в начале/конце.',
          '# выведи строку\n',
          'print("Hello, Кодиум")',
          [
            t('Ровный текст приветствия', 'Hello, Кодиум'),
            t('Повторная проверка той же строки', 'Hello, Кодиум')
          ]
        ),
        lesson(
          'python-basics-m1-l2',
