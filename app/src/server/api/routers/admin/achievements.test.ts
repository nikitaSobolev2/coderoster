...
describe('admin.achievements router (integration)', () => {
  it('achievements_throws_FORBIDDEN_for_LEARNER', async () => {
    ...
    await expect(caller.admin.achievements.list()).rejects.toThrow(/FORBIDDEN|denied/i)
  })
})
