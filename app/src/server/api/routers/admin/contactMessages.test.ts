...
describe('admin.contactMessages router (integration)', () => {
  it('contactMessages_throws_FORBIDDEN_for_LEARNER', async () => {
    ...
    await expect(caller.admin.contactMessages.list({})).rejects.toThrow(/FORBIDDEN|denied/i)
  })
})
